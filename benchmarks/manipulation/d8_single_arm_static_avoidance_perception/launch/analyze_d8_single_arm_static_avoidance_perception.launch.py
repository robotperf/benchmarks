...
def generate_launch_description():
    ...
    analyzer = ExecuteProcess(
        cmd=[
            'python3', "src/benchmarks/benchmarks/manipulation/d8_single_arm_static_avoidance_perception/launch/analyze_d8_single_arm_static_avoidance_perception.launch.py",
