...
def analyze_distance_calculation_process_cp(argv):
    ...
    if hardware_device_type == 'cpu':
        ...
        ## using message header id
        target_chain = [
            "dual_arm_static_avoidance:distance_calculation_process_cp_init",        # 0
            "dual_arm_static_avoidance:distance_calculation_process_cp_fini",        # 1
        ]

        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_process_cp_init",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_process_cp_init",
                "colors_fg": "yellow",
                "colors_fg_bokeh": "salmon",
                "layer": "userland",
                "label_layer": 4,
        ...
        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_process_cp_fini",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_process_cp_fini",
                "colors_fg": "red",
                "colors_fg_bokeh": "darksalmon",
                "layer": "userland",
                "label_layer": 4,
...
if __name__ == '__main__':
    ...
    analyze_distance_calculation_process_cp(sys.argv[1:])
