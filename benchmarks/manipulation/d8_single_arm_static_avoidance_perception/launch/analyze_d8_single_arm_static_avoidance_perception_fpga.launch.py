...
def analyze_distance_calculation_morph_operations(argv):
    ...
    if hardware_device_type == 'cpu':
        ...
        ## using message header id
        target_chain = [
            "dual_arm_static_avoidance:distance_calculation_morph_operations_init",        # 0
            "dual_arm_static_avoidance:distance_calculation_morph_operations_fini",        # 1
        ]

        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_morph_operations_init",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_morph_operations_init",
                "colors_fg": "yellow",
                "colors_fg_bokeh": "salmon",
                "layer": "userland",
                "label_layer": 4,
        ...
        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_morph_operations_fini",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_morph_operations_fini",
                "colors_fg": "red",
                "colors_fg_bokeh": "darksalmon",
                "layer": "userland",
                "label_layer": 4,
...
def analyze_distance_calculation_get_edges(argv):
    ...
    if hardware_device_type == 'cpu':
        ...
        ## using message header id
        target_chain = [
            "dual_arm_static_avoidance:distance_calculation_get_edges_init",        # 0
            "dual_arm_static_avoidance:distance_calculation_get_edges_fini",        # 1
        ]

        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_get_edges_init",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_get_edges_init",
                "colors_fg": "yellow",
                "colors_fg_bokeh": "salmon",
                "layer": "userland",
                "label_layer": 4,
        ...
        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_get_edges_fini",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_get_edges_fini",
                "colors_fg": "red",
                "colors_fg_bokeh": "darksalmon",
                "layer": "userland",
                "label_layer": 4,
...
def analyze_distance_calculation_find_contours(argv):
    ...
    if hardware_device_type == 'cpu':
        ...
        ## using message header id
        target_chain = [
            "dual_arm_static_avoidance:distance_calculation_find_contours_init",        # 0
            "dual_arm_static_avoidance:distance_calculation_find_contours_fini",        # 1
        ]

        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_find_contours_init",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_find_contours_init",
                "colors_fg": "yellow",
                "colors_fg_bokeh": "salmon",
                "layer": "userland",
                "label_layer": 4,
        ...
        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_find_contours_fini",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_find_contours_fini",
                "colors_fg": "red",
                "colors_fg_bokeh": "darksalmon",
                "layer": "userland",
                "label_layer": 4,
...
def analyze_distance_calculation_filter_contours(argv):
    ...
    if hardware_device_type == 'cpu':
        ...
        ## using message header id
        target_chain = [
            "dual_arm_static_avoidance:distance_calculation_filter_contours_init",        # 0
            "dual_arm_static_avoidance:distance_calculation_filter_contours_fini",        # 1
        ]

        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_filter_contours_init",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_filter_contours_init",
                "colors_fg": "yellow",
                "colors_fg_bokeh": "salmon",
                "layer": "userland",
                "label_layer": 4,
        ...
        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_filter_contours_fini",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_filter_contours_fini",
                "colors_fg": "red",
                "colors_fg_bokeh": "darksalmon",
                "layer": "userland",
                "label_layer": 4,
...
def analyze_distance_calculation_process_cps(argv):
    ...
    if hardware_device_type == 'cpu':
        ...
        ## using message header id
        target_chain = [
            "dual_arm_static_avoidance:distance_calculation_process_cps_init",        # 0
            "dual_arm_static_avoidance:distance_calculation_process_cps_fini",        # 1
        ]

        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_process_cps_init",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_process_cps_init",
                "colors_fg": "yellow",
                "colors_fg_bokeh": "salmon",
                "layer": "userland",
                "label_layer": 4,
        ...
        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_process_cps_fini",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_process_cps_fini",
                "colors_fg": "red",
                "colors_fg_bokeh": "darksalmon",
                "layer": "userland",
                "label_layer": 4,
...
def analyze_distance_calculation_process_cp_fpga_part1(argv):
    ...
    if hardware_device_type == 'cpu':
        ...
        ## using message header id
        target_chain = [
            "dual_arm_static_avoidance:distance_calculation_process_cp_fpga_part1_init",        # 0
            "dual_arm_static_avoidance:distance_calculation_process_cp_fpga_part1_fini",        # 1
        ]

        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_process_cp_fpga_part1_init",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_process_cp_fpga_part1_init",
                "colors_fg": "yellow",
                "colors_fg_bokeh": "salmon",
                "layer": "userland",
                "label_layer": 4,
        ...
        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_process_cp_fpga_part1_fini",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_process_cp_fpga_part1_fini",
                "colors_fg": "red",
                "colors_fg_bokeh": "darksalmon",
                "layer": "userland",
                "label_layer": 4,
...
def analyze_distance_calculation_send_data_to_driver(argv):
    ...
    if hardware_device_type == 'cpu':
        ...
        ## using message header id
        target_chain = [
            "dual_arm_static_avoidance:distance_calculation_send_data_to_driver_init",        # 0
            "dual_arm_static_avoidance:distance_calculation_send_data_to_driver_fini",        # 1
        ]

        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_send_data_to_driver_init",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_send_data_to_driver_init",
                "colors_fg": "yellow",
                "colors_fg_bokeh": "salmon",
                "layer": "userland",
                "label_layer": 4,
        ...
        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_send_data_to_driver_fini",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_send_data_to_driver_fini",
                "colors_fg": "red",
                "colors_fg_bokeh": "darksalmon",
                "layer": "userland",
                "label_layer": 4,
...
def analyze_distance_calculation_send_data_to_fpga(argv):
    ...
    if hardware_device_type == 'cpu':
        ...
        ## using message header id
        target_chain = [
            "dual_arm_static_avoidance:distance_calculation_send_data_to_fpga_init",        # 0
            "dual_arm_static_avoidance:distance_calculation_send_data_to_fpga_fini",        # 1
        ]

        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_send_data_to_fpga_init",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_send_data_to_fpga_init",
                "colors_fg": "yellow",
                "colors_fg_bokeh": "salmon",
                "layer": "userland",
                "label_layer": 4,
        ...
        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_send_data_to_fpga_fini",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_send_data_to_fpga_fini",
                "colors_fg": "red",
                "colors_fg_bokeh": "darksalmon",
                "layer": "userland",
                "label_layer": 4,
...
def analyze_distance_calculation_fpga_operation(argv):
    ...
    if hardware_device_type == 'cpu':
        ...
        ## using message header id
        target_chain = [
            "dual_arm_static_avoidance:distance_calculation_fpga_operation_init",        # 0
            "dual_arm_static_avoidance:distance_calculation_fpga_operation_fini",        # 1
        ]

        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_fpga_operation_init",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_fpga_operation_init",
                "colors_fg": "yellow",
                "colors_fg_bokeh": "salmon",
                "layer": "userland",
                "label_layer": 4,
        ...
        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_fpga_operation_fini",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_fpga_operation_fini",
                "colors_fg": "red",
                "colors_fg_bokeh": "darksalmon",
                "layer": "userland",
                "label_layer": 4,
...
def analyze_distance_calculation_read_from_fpga(argv):
    ...
    if hardware_device_type == 'cpu':
        ...
        ## using message header id
        target_chain = [
            "dual_arm_static_avoidance:distance_calculation_read_from_fpga_init",        # 0
            "dual_arm_static_avoidance:distance_calculation_read_from_fpga_fini",        # 1
        ]

        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_read_from_fpga_init",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_read_from_fpga_init",
                "colors_fg": "yellow",
                "colors_fg_bokeh": "salmon",
                "layer": "userland",
                "label_layer": 4,
        ...
        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_read_from_fpga_fini",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_read_from_fpga_fini",
                "colors_fg": "red",
                "colors_fg_bokeh": "darksalmon",
                "layer": "userland",
                "label_layer": 4,
...
def analyze_distance_calculation_read_from_driver(argv):
    ...
    if hardware_device_type == 'cpu':
        ...
        ## using message header id
        target_chain = [
            "dual_arm_static_avoidance:distance_calculation_read_from_driver_init",        # 0
            "dual_arm_static_avoidance:distance_calculation_read_from_driver_fini",        # 1
        ]

        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_read_from_driver_init",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_read_from_driver_init",
                "colors_fg": "yellow",
                "colors_fg_bokeh": "salmon",
                "layer": "userland",
                "label_layer": 4,
        ...
        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_read_from_driver_fini",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_read_from_driver_fini",
                "colors_fg": "red",
                "colors_fg_bokeh": "darksalmon",
                "layer": "userland",
                "label_layer": 4,
...
def analyze_distance_calculation_getobstacle_distances(argv):
    ...
    if hardware_device_type == 'cpu':
        ...
        ## using message header id
        target_chain = [
            "dual_arm_static_avoidance:distance_calculation_getobstacle_distances_init",        # 0
            "dual_arm_static_avoidance:distance_calculation_getobstacle_distances_fini",        # 1
        ]

        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_getobstacle_distances_init",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_getobstacle_distances_init",
                "colors_fg": "yellow",
                "colors_fg_bokeh": "salmon",
                "layer": "userland",
                "label_layer": 4,
        ...
        ba.add_target(
            {
                "name": "dual_arm_static_avoidance:distance_calculation_getobstacle_distances_fini",
                "name_disambiguous": "dual_arm_static_avoidance:distance_calculation_getobstacle_distances_fini",
                "colors_fg": "red",
                "colors_fg_bokeh": "darksalmon",
                "layer": "userland",
                "label_layer": 4,
...
if __name__ == '__main__':
    ...
    analyze_tf2_operations(sys.argv[1:])
    analyze_dual_arm_cp_calculation(sys.argv[1:])
    # further instrument and obtain data from the calculations
    analyze_distance_calculation_morph_operations(sys.argv[1:])
    analyze_distance_calculation_get_edges(sys.argv[1:])
    analyze_distance_calculation_find_contours(sys.argv[1:])
    analyze_distance_calculation_filter_contours(sys.argv[1:])
    analyze_distance_calculation_process_cps(sys.argv[1:])
    analyze_distance_calculation_process_cp_fpga_part1(sys.argv[1:])
    analyze_distance_calculation_send_data_to_driver(sys.argv[1:])
    analyze_distance_calculation_send_data_to_fpga(sys.argv[1:])
