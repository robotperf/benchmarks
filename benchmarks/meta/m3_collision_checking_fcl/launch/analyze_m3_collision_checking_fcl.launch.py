...
def main(argv):
    ...
    ba = BenchmarkAnalyzer('m3_collision_checking_fcl', hardware_device_type, tf_tree)
...
def generate_launch_description():
    ...
    analyzer = ExecuteProcess(
        cmd=[
            'python3', "src/benchmarks/benchmarks/meta/m3_collision_checking_fcl/launch/analyze_m3_collision_checking_fcl.launch.py",
