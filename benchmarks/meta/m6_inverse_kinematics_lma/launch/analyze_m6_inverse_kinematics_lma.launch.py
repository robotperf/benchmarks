...
def main(argv):
    ...
    ba = BenchmarkAnalyzer('m6_inverse_kinematics_lma', hardware_device_type, tf_tree)
...
def generate_launch_description():
    ...
    analyzer = ExecuteProcess(
        cmd=[
            'python3', "src/benchmarks/benchmarks/meta/m6_inverse_kinematics_lma/launch/analyze_m6_inverse_kinematics_lma.launch.py",
