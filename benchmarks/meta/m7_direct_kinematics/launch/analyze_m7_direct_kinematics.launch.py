...
def main(argv):
    ...
    ba = BenchmarkAnalyzer('m7_direct_kinematics', hardware_device_type, tf_tree)
...
def generate_launch_description():
    ...
    analyzer = ExecuteProcess(
        cmd=[
            'python3', "src/benchmarks/benchmarks/meta/m7_direct_kinematics/launch/analyze_m7_direct_kinematics.launch.py",
