...
def main(argv):
    ...
    ba = BenchmarkAnalyzer('m5_inverse_kinematics_kdl', hardware_device_type, tf_tree)
...
def generate_launch_description():
    ...
    analyzer = ExecuteProcess(
        cmd=[
            'python3', "src/benchmarks/benchmarks/meta/m5_inverse_kinematics_kdl/launch/analyze_m5_inverse_kinematics_kdl.launch.py",
