...
def main(argv):
    ...
    ba = BenchmarkAnalyzer('m2_xarm6_planning_and_traj_execution', hardware_device_type, tf_tree)
...
def generate_launch_description():
    ...
    analyzer = ExecuteProcess(
        cmd=[
            'python3', "src/benchmarks/benchmarks/meta/m2_xarm6_planning_and_traj_execution/launch/analyze_m2_xarm6_planning_and_traj_execution.launch.py",
