...
def main(argv):
    ...
    ba = BenchmarkAnalyzer('n3_inter_network', hardware_device_type)
...
def generate_launch_description():
    ...
    analyzer = ExecuteProcess(
        cmd=[
            'python3', "src/benchmarks/benchmarks/network/n3_inter_network/launch/analyze_n3_inter_network.launch.py",
