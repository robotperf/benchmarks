...
def generate_launch_description():
    print('it enters launch description')
...
#ros2 launch a5_resize analyze_a5_resize_amf.launch.py trace_path:=/home/amf/.ros/tracing/a5_resize metrics:="[latency, throughput]"