...
def main(argv):
    ...
    ba = BenchmarkAnalyzer('n1_intra_process', hardware_device_type)
...
def generate_launch_description():
    ...
    analyzer = ExecuteProcess(
        cmd=[
            'python3', "src/benchmarks/benchmarks/middleware/n1_intra_process/launch/analyze_n1_intra_process.launch.py",
