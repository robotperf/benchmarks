...
def main(argv):
    ...
    ba = BenchmarkAnalyzer('n8_inter_network_vpn_security', hardware_device_type)
...
def generate_launch_description():
    ...
    analyzer = ExecuteProcess(
        cmd=[
            'python3', "src/benchmarks/benchmarks/middleware/n8_inter_network_vpn_security/launch/analyze_n8_inter_network_vpn_security.launch.py",
